...
_params = ParamGrid(
    [
        ...
        ("quads_obst_size_min", [0.2]),
        ("quads_obst_size_max", [0.4]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_obst_density=0.2 --replay_buffer_sample_prob=0.75 --quads_critic_obs=octomap '
    # Random
    '--quads_obst_density_random=False --quads_obst_density_min=0.2 --quads_obst_density_max=0.3 '
    '--quads_obst_size_random=True --quads_obst_noise=0.05 '
    # SBC
    '--quads_enable_sbc=False --quads_neighbor_range=2.0 --quads_obst_range=2.0 '
    '--quads_coeff_sbc_acc=0.2 --quads_coeff_sbc_boundary=0.01 '
