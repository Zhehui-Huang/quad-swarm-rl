...
_params = ParamGrid(
    [
        ("seed", [0000, 3333, 6666]),
        ("quads_neighbor_obs_update_freq", [5, 10, 20, 50]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=search_neighbor_update_freq'
)

_experiment = Experiment(
    "search_neighbor_update_freq",
    OBSTACLE_MODEL_CLI,
