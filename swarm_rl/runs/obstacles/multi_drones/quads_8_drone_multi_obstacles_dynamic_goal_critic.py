...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_critic_rnn_size", [64]),
        ("quads_sbc_obst_agg", [0.05, 0.1]),
    ]
)

OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    # Obst related
    ' --quads_room_dims 8.0 8.0 5.0 --quads_obst_spawn_area 8 4 --quads_obst_grid_size=0.5 '
    ...
    '--quads_coeff_spin=0.0 --quads_coeff_omega=0.1 --quads_coeff_sbc_acc=0.2 --quads_coeff_sbc_boundary=0.01 '
    # Aux
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=critic_sbc_obst_agg_v1'
)

_experiment = Experiment(
    "critic_sbc_obst_agg_v1",
    OBSTACLE_MODEL_CLI,
