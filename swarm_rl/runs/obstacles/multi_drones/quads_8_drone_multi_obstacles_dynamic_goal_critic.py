...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_obst_min_gap_threshold", [0.4]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    # SBC
    '--quads_enable_sbc=True --quads_neighbor_range=2.0 --quads_obst_range=2.0 --quads_sbc_obst_agg=0.2 '
    '--quads_coeff_sbc_acc=1.0 --quads_coeff_sbc_boundary=0.0 '
    # Aux
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=search_imit_learning_v1'
)

_experiment = Experiment(
    "search_imit_learning_v1",
    OBSTACLE_MODEL_CLI,
