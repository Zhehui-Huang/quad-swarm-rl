...
_params = ParamGrid(
    [
        ...
        ("quads_obst_size_random", [True, False]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_obst_size_min=0.2 --quads_obst_size_max=0.4 '
    # SBC
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=random_obst_size_v1'
)
