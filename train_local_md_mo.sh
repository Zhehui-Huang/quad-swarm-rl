...
--quads_obst_collision_prox_min=0.05 --quads_obst_collision_prox_max=0.5 --quads_obst_collision_prox_weight=0.1 \
--with_wandb=False --wandb_project=Quad-Swarm-RL --wandb_user=darren-personal --wandb_group=md_mo_baseline_local \
--experiment=test_multi_drone_small_room \