...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=adir_ro_search_rew_effort_v1'
)

_experiment = Experiment(
    "adir_ro_search_rew_effort_v1",
    OBSTACLE_MODEL_CLI,
