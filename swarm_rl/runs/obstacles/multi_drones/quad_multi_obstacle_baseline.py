QUAD_BASELINE_CLI_8 = (
    ...
    # Neighbor
    '--quads_neighbor_hidden_size=-1 --quads_neighbor_obs_type=pos_vel --quads_collision_hitbox_radius=2.0 '
    ...
    '--quads_obst_collision_reward=5.0 --quads_obstacle_obs_type=ToFs --quads_obst_hidden_size=-1 '
