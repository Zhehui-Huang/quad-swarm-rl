...
_params = ParamGrid(
    [
        ("seed", [2222]),
        ("quads_obst_collision_prox_weight", [0.0, 0.1, 0.5, 1.0]),
        ("quads_obst_collision_prox_min", [0.0, 0.05, 0.1]),
    ]
)

OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ' --quads_episode_duration=30.0 --num_envs_per_worker=4 --rnn_size=16 --quads_obs_repr=xyz_vxyz_R_omega --quads_dynamic_goal=True --normalize_input=True '
