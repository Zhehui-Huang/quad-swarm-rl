...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_coeff_omega=0.1 --quads_coeff_spin=0.0 --quads_coeff_sbc_acc=0.2 --quads_coeff_sbc_boundary=0.01 '
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=sbc_pid_v1'
)
