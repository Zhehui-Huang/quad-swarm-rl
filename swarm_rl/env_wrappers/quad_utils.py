...
def make_quadrotor_env_multi(cfg, render_mode=None, **kwargs):
    ...
    env = QuadrotorEnvMulti(
        ...
        obs_repr=cfg.quads_obs_repr, obs_rel_rot=cfg.quads_obs_rel_rot, dynamic_goal=False, use_ctbr=cfg.quads_use_ctbr,
        # Neighbor
        ...
        neighbor_obs_update_freq=cfg.quads_neighbor_obs_update_freq,
        # Obstacle
    ...
    reward_shaping['quad_rewards']['quads_obst_collision_prox_weight'] = cfg.quads_obst_collision_prox_weight
    reward_shaping['quad_rewards']['quads_obst_collision_prox_max'] = cfg.quads_obst_collision_prox_max
    reward_shaping['quad_rewards']['quads_obst_collision_prox_min'] = cfg.quads_obst_collision_prox_min
    ...
    if cfg.anneal_collision_steps > 0:
        ...
        reward_shaping['quad_rewards']['quads_obst_collision_prox_weight'] = 0.0
        reward_shaping['quad_rewards']['quads_obst_collision_prox_max'] = 0.0
        reward_shaping['quad_rewards']['quads_obst_collision_prox_min'] = 0.0
