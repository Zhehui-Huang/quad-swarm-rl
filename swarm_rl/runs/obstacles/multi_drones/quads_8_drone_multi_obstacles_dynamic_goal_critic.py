...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_obst_spawn_center=False --quads_obst_grid_size_range 1.0 1.0 --quads_obst_grid_size_random=False '
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=b_all_debug_all_dir_v3'
)

_experiment = Experiment(
    "b_all_debug_all_dir_v3",
    OBSTACLE_MODEL_CLI,
