...
--run=swarm_rl.runs.obstacles.multi_drones.quads_8_drone_multi_obstacles_dynamic_goal \
...
--slurm_sbatch_template=/home/zhehui/slurm/swarm-rl-311_sbatch_timeout.sh \
