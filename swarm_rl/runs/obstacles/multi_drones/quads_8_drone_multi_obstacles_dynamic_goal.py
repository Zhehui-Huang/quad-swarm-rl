...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_coeff_sbc_acc", [0.0, 0.01, 0.1]),
        ("quads_coeff_sbc_boundary", [0.0, 0.01, 0.1]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=sbc_coeff_v1'
)
