...
_params = ParamGrid(
    [
        ("seed", [6666]),
        ("quads_obst_collision_prox_weight", [0.001, 0.01, 0.1, 0.5, 1.0]),
        ("quads_obst_collision_prox_min", [0.01, 0.05, 0.1, 0.2]),
    ]
)

OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ' --quads_room_dims 8.0 8.0 5.0 --quads_obst_spawn_area 4 4 '
