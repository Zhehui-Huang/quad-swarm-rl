...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_obst_collision_prox_max", [0.1]),
        ("quads_coeff_z_overlap", [0.05]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_obst_collision_prox_weight=0.05 --quads_obst_collision_prox_min=0.01 '
    ...
    # W & B
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_user=multi-drones --wandb_group=adir_ro_change_model_arch_v1'
)

_experiment = Experiment(
    "adir_ro_change_model_arch_v1",
    OBSTACLE_MODEL_CLI,
