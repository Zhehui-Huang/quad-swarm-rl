...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--quads_neighbor_obs_update_freq', default=5, type=int,
    ...
    p.add_argument('--quads_obst_min_gap_threshold', default=0.4, type=float,
                   help='The minimum gap between obstacles')
